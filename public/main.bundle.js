...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__guard_auth_guard_service__ = __webpack_require__("../../../../../src/app/guard/auth-guard.service.ts");
...
AppRoutingModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
        declarations: [],
        imports: [__WEBPACK_IMPORTED_MODULE_0__angular_router__["a" /* RouterModule */].forRoot(appRoutes), __WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__["a" /* BrowserModule */]],
        providers: [__WEBPACK_IMPORTED_MODULE_3__guard_auth_guard_service__["a" /* AuthGuard */]],
        bootstrap: [],
...
var AuthGuard = (function () {
    ...
    AuthGuard.prototype.canActivate = function (router, previous) {
...
var AuthService = (function () {
    function AuthService(http) {
        this.http = http;
        this.doamin = "http://localhost:8080";
    }
    AuthService.prototype.createAuthentiocationHeaders = function () {
        this.loadToken();
    ...
    AuthService.prototype.registerUser = function (user) {
        return this.http.post(this.doamin + "/authentication/register", user).map(function (res) { return res.json(); });
    };
    AuthService.prototype.loginUser = function (user) {
        return this.http.post(this.doamin + "/authentication/login", user).map(function (res) { return res.json(); });
    };
    AuthService.prototype.checkusername = function (username) {
        return this.http.get(this.doamin + "/authentication/checkUsername/" + username).map(function (res) { return res.json(); });
    };
    AuthService.prototype.checkEmail = function (email) {
        return this.http.get(this.doamin + "/authentication/checkEmail/" + email).map(function (res) { return res.json(); });
    };
    ...
    AuthService.prototype.getProfile = function () {
        ...
        return this.http.get(this.doamin + "/authentication/profile", this.options).map(function (res) { return res.json(); });
    };
    return AuthService;
}());
