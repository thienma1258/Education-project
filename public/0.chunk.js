...
var TestService = (function () {
    ...
    TestService.prototype.getalltest = function () {
        return this.http.get(this.domain + "Test/alltestinformation").map(function (res) { return res.json(); });
    };
    TestService.prototype.getdetailtest = function (id) {
        this.auth.createAuthentiocationHeaders();
        return this.http.get(this.domain + "Test/testdetail/" + id, this.auth.options).map(function (res) { return res.json(); });
    };
    TestService.prototype.getquestion = function (id) {
        this.auth.createAuthentiocationHeaders();
        var req = {
            id: id
        };
        return this.http.put(this.domain + "Test/testquestion", req, this.auth.options).map(function (res) { return res.json(); });
    };
    TestService.prototype.submitanswer = function (answer, id) {
        this.auth.createAuthentiocationHeaders();
        var req = {
            answer: answer,
            id: id
        };
        return this.http.post(this.domain + "Test/submitanswer", req, this.auth.options).map(function (res) { return res.json(); });
    };
    TestService.prototype.jointest = function (id) {
        this.auth.createAuthentiocationHeaders();
        return this.http.get(this.domain + "Test/jointest/" + id, this.auth.options).map(function (res) { return res.json(); });
    };
    return TestService;
}());
